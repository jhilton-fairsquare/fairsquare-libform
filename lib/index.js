...
// Drop-in presets — minimal config, opinionated defaults. The Framer preset
// covers the common Fairsquare landing-page case. Fall back to createForm
// directly when you need anything outside the preset's scope.
import { framerForm } from "./presets/framer.js";
export const presets = { framer: framerForm };
