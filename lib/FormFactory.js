...
export function createForm(config) {
  ...
  // Match a form identified by EITHER a `data-form="<id>"` attribute OR an
  // `id="<id>"` attribute. The latter is what Framer's "Identifier" field
  // emits, which is the most common Framer authoring convention.
  // When we resolve via id, stamp `data-form` so all downstream selectors
