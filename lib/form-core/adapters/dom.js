...
const errorContainerFor = (input) => {
  ...
  // Prefer an explicit wrapper class. Falling back to a generic ancestor
  // (any <div> or the form itself) would render the error outside the
  // surrounding form when no wrapper exists.
